...
|    :-:   |    :-:   |     :-:     |
| `PTERO_PANEL_URL` | Yes | Server URL of your Pterodactyl Panel |
| `PTERO_PANEL_TOKEN` | Yes | API Key (created via `/account/api`) |
| `PTERO_PANEL_SERVER_ID` | Yes | ID of the server you want to restart |
| `PRE_RESTART_COMMAND` | No | A command to run before the server restarts |
